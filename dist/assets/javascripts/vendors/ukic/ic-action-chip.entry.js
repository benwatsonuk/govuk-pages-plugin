...
import { r as removeDisabledFalse, o as onComponentRequiredPropUndefined, a as renderDynamicChildSlots, i as isSlotUsed, b as isElInAGGrid } from './helpers-dcedb279.js';
...
const ActionChip = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2c65125774e7ce4fc9cb0d447e0ebff984caad5a', class: {
                [`ic-theme-${theme}`]: theme !== "inherit",
            } }, h(TagType, Object.assign({ key: 'af57a8bb5d0b29b4ff1023747bc0d4ca3824af73', class: {
                chip: true,
                ...
                [`${size}`]: true,
                [`${variant}`]: true,
            }, ref: (el) => (this.chipEl = el) }, chipAttrs), isSlotUsed(this.el, "icon") && (h("div", { key: '755a2318e2968614423a5b88b2831e259caef7e3', class: "icon" }, h("slot", { key: '4137b19dc8fc2be40a7ccf696f820e30c1b668b0', name: "icon" }))), h("ic-typography", { key: '2b8615d3bce8b9b0d4b5e89cceac2b97b8d95105', variant: "label", class: { label: true, "in-ag-grid": isElInAGGrid(this.el) } }, h("span", { key: '3f5d55931b36640b30b472fcc4febecb6d502189' }, label)), !isButtonElement && target === "_blank" && (h("span", { key: 'd0c2331424af931db24f5d9fe2dc3500bf31db46', class: "open-in-new-icon", innerHTML: OpenInNew })), isSlotUsed(this.el, "badge") && h("slot", { key: 'b0451850fd5b42f4120b7fa6e943332d64e52690', name: "badge" }))));
    }
...
export { ActionChip as ic_action_chip };
