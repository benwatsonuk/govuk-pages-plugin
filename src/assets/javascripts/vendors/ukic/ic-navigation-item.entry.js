...
import { z as getCssProperty, D as DEVICE_SIZES, g as getBrandForegroundAppearance, f as getCurrentDeviceSize, y as getNavItemParentDetails } from './helpers-dcedb279.js';
...
const NavigationItem = class {
    constructor(hostRef) {
        ...
        this.displayDefaultNavigationItem = (href, label, hreflang, target, rel, referrerpolicy, download) => {
            ...
            const ChevronIconComponent = this.expandable && (h("div", { class: { svg: true }, innerHTML: Chevron }));
...
NavigationItem.style = IcNavigationItemStyle0;

export { NavigationItem as ic_navigation_item };

//# sourceMappingURL=ic-navigation-item.entry.js.map